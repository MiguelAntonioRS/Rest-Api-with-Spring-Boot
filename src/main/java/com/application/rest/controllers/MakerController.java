...
public class MakerController {
    ...
    public ResponseEntity<?> findById(@PathVariable Long id) {
        ...
        if (makerOptional.isPresent()) {
            ...
            MakerDTO makerDTO = MakerDTO.builder().id(maker.getId())
                    .name(maker.getName()).productList(maker.getProductList()).build();
    ...
    public ResponseEntity<?> findAll() {
        List<MakerDTO> makerList = makerService.findAll()
                ...
                .map(maker -> MakerDTO.builder()
                        .id(maker.getId())
                        .name(maker.getName()).productList(maker.getProductList())
                        .build()).toList();
